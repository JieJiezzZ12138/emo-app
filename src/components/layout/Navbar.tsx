...
export function Navbar() {
  ...
  return (
    ...
    >
      <Link href="/" className="text-lg font-light tracking-[0.3em] text-white/80 hover:text-white transition-colors">
        EMO
      </Link>
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              className="relative px-3 py-2 text-sm text-white/50 hover:text-white/90 transition-colors"
            >
